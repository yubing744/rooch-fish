...
module rooch_fish::economic_system_test {
    ...
    fun test_economic_system(admin: signer, player1: signer, player2: signer) {
        ...
        // Get pond info
        let (_, _, _, purchase_amount, max_food_per_feed, food_value_ratio) = rooch_fish::get_pond_info(POND_ID_SMALL);
        ...
        rooch_fish::set_fish_position_for_test(POND_ID_LARGE, fish1_large, 500, 500); // Assuming exit zone is at center
        let initial_balance = gas_coin::balance(player1_addr);
